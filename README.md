...
3. საიტი: `https://triangulationtsmu.github.io/Triangulation/`
   UCEEM საჯარო ბმული: `.../Triangulation/uceem.html`
...
- **ჯგუფის დაარქივება/წაშლა**: მხოლოდ ადმინს შეუძლია. დაარქივებული ჯგუფის
  ...
  მხოლოდ ჯგუფის ჩანაწერს და სტუდენტები სისტემაში რჩებიან.
- **შეფასება**: *სამუშაო სივრცე* → დეპარტამენტი → (წელი/სემესტრი) → ჯგუფი →
  სტუდენტის გასწვრივ **Mini-CEX / CBD / DOPS / MSF / WBA Summary / MSF Resume**.
  `kakha` account-ზე შემფასებელი ავტომატურად ივსება კახაბერ ჭელიძით; სხვა
  shared role account-ებზე შემფასებელი შეფასების ფორმაში ხელით წერს საკუთარ
  სახელს და გვარს.
- **UCEEM ბმული**: *UCEEM ბმული* → **UCEEM ლინკის კოპირება**. ფორმა პირდაპირ
  იხსნება და სტუდენტი ირჩევს დეპარტამენტს, კურაციას, სემესტრს და ჯგუფს.
- **ანონიმური ბმული**: საჯარო ბმული არის `uceem.html`; კამპანიის შექმნა საჭირო
  აღარ არის.
...
- ✅ შეფასებას ინახავს ავტორიზებული მომხმარებელი; shared role account-ებზე
  ფორმაში შემფასებლის სახელი/გვარი და როლი ხელით იწერება.
- ✅ UCEEM პასუხი respondent-ის ვინაობის გარეშე ინახება; rules კრძალავს
  იდენტიფიცირებელ ველებს.
- ✅ UCEEM საჯარო გვერდი პირდაპირ იხსნება და respondent-ის ვინაობას არ ითხოვს.
